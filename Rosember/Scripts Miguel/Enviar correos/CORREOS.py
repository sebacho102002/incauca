...
def main():
    try:
        ...
        correos_por_zona = {
            'Oriental Incauca': ('juan.bejarano03@usc.edu.co'),
            'Central Incauca': ('juan.bejarano03@usc.edu.co'),
            'Sur Incauca': ('juan.bejarano03@usc.edu.co'),
            'Jamundí Incauca': ('juan.bejarano03@usc.edu.co'),
            'Occidental Incauca': ('juan.bejarano03@usc.edu.co'),
            'Norte Incauca': ('juan.bejarano03@usc.edu.co'),
            'Sur Occidental Incauca': ('juan.bejarano03@usc.edu.co')
