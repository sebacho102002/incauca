        ...
        if nodo_actual.es_meta():
            ...
            for operador in self.operadores:
                nodo_hijo = Nodo(nodo_actual.estado,
                                  ...
                                  self.heuristica(nodo_actual),
                                  nodo_actual.costo + nodo_actual.cubeta_con_agua + 1+self.heuristica(nodo_actual))
                ...
                if self.verificar_restricciones(nodo_hijo, nodo_padre, operador):
                    ...
                    self.lista_nodos.sort(key=lambda nodo: nodo.costo_mas_heuristica)
